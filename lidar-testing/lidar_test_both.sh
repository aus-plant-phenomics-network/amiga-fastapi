...
python  /mnt/managed_home/farm-ng-user-gsainsbury/amiga-fastapi/lidar-testing/test_lidar.py /mnt/managed_home/farm-ng-user-gsainsbury/sick_scan_ws/sick_scan_xd/launch/sick_lms_4xxx.launch hostname:=10.95.76.103 & python /mnt/managed_home/farm-ng-user-gsainsbury/amiga-fastapi/lidar-testing/test_lidar.py /mnt/managed_home/farm-ng-user-gsainsbury/sick_scan_ws/sick_scan_xd/launch/sick_lms_4xxx.launch hostname:=10.95.76.102
